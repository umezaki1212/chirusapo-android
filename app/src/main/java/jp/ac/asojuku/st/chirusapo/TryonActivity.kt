...
//    private fun addPhoto(pathString:String){
//        val imageView = ImageView(this)
//        val stream = FileInputStream(pathString)
//        val bitmap = BitmapFactory.decodeStream(BufferedInputStream(stream))
//        imageView.setImageBitmap(bitmap)
//
//        val params =
...
//        val fileDir = "file://$path/afterPhoto/$fileName.jpg"
//        val output = FileOutputStream(fileDir)
//        val view = findViewById<ImageView>(R.id.imageChildModel)
